...
function my_keydown(e) {
  ...
  function up() {
    if (ball_y >= 5) {
      ...
      console.log(
        'Quando a tecla para cima é pressionada, X =  ' +
          ball_x +
          ' , Y = ' +
          ball_y
      )
  ...
  function up() {
    if (ball_y >= 5) {
      ...
      console.log('altura da imagem do bloco = + block_image_height')
      console.log(
        'Quando a tecla para cima pressionada, X = ' +
          ball_x +
          ', Y = ' +
          ball_y
      )
  ...
  function down() {
    if (ball_y <= 450) {
      ...
      console.log('altura da imagem do bloco + block_image_height')
      console.log(
        'Quando a tecla para baixo é pressionada, X = + ball_x + ',
        (Y = '+ball_y')
      )
      canvas.remove(ball_obj)
      new_image()
  ...
  function left() {
    if (ball_x > 5) {
      ...
      console.log(
        'Quando a tecla esquerda é pressionada, X = + ball_x + ',
        (Y = '+ball_y')
      )
      canvas.remove(ball_obj)
      new_image()
  ...
  function right() {
    if (ball_x <= 1050) {
      ...
      console.log('largura da imagem do bloco = + block_image_width')
      console.log(
        'Quando a tecla direita é pressionada, X = + ball_x + ',
        (Y = '+ball_y')
      )
      canvas.remove(ball_obj)
      new_image()
